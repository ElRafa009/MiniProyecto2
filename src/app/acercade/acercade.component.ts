...
export class AcercadeComponent {
  ...
  luis: usuario = {
    nombre: "Luis Javier",
    descripcion: "Estudiante de la UAA de la carrera de ISC del salón abajo de los baños que están cerca del jardín de las generaciones",
  }
  ...
  ana: usuario = {
    nombre: "Ana Delia",
    descripcion: "Chica introvertida que gusta de la vida, un libro y un café a la luz de la Luna."
  }
